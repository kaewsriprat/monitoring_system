...
<div class="row">
    <div class="col-12 text-center col-md-8 text-md-start">
        <p class="fw-bold fs-3 px-3 text-primary">เป้าหมายรวม</p>
    </div>
    <div class="col-12 text-center col-md-4 text-md-end">
        <div>
            <a class="btn btn-label-primary me-0 me-md-3" href="create/major">
...
<script>
    ...
    async function initIndTable() {
        ...
        let data = await fetchIndicators(year, 1);
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data) {
                        return `<span class="text-truncate" style="max-width: 150px;" data-bs-toggle="tooltip" data-bs-placement="top" title="${data}">${data}</span>`;
                    }
                },
                {
                    data: 'goal_title'
    ...
    function sparklineChart(ele, dataSet) {
        ...
        const options = {
            ...
            stroke: {
                width: 2,
                curve: 'smooth',
                colors: ['#696cff'] // Sets the stroke color for the line.
            },
            yaxis: {
                min: min - 5,
                max: max + 5,
