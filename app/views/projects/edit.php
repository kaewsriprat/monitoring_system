                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-12 col-md-3">
                                <div class="form-group input-group-lg">
                                    ...
                                    <select class="form-select" id="yearsSelect" name="yearsSelect" readonly disabled>
                                        <option value="" disabled selected>เลือกปีงบประมาณ</option>
                                        <?php for ($year = $currentYear; $year >= $startYear; $year--) : ?>
                                            <option value="<?= $year ?>" <?= $year == $project['project_year'] ? 'selected' : '' ?>><?= $year ?></option>
                                        <?php endfor; ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-12 col-md-6">
                                <div class="form-group input-group-lg">
                                    ...
                                    <input type="text" class="form-control" id="projetName" name="projetName" placeholder="ชื่อโครงการ" value="<?= $project['project_name']; ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group input-group-lg">
                                    ...
                                    <input type="text" class="form-control" id="budget" name="budget" placeholder="งบประมาณ" value="<?= intval($project['total_budget']); ?>" number>
                                </div>
                            </div>
...
<script>
    ...
    function formSubmit() {
        ...
        swal.fire({
            ...
            customClass: {
                ...
                cancelButton: "btn btn-outline-secondary me-4"
            },
    ...
    function cancelCreate() {
        swal.fire({
            title: 'ยกเลิกการปรับปรุงโครงการ',
    ...
    async function appendStrategies() {
        ...
        const strategyId = '<?= $project['strategy_ops']??0; ?>';
