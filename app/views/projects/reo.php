...
<script>
    ...
    function initDatatable(data) {
        ...
        dataTable = $('#projectsTable').DataTable({
            ...
            columnDefs: [{
                    targets: [0, 2, -1],
                    className: 'text-center w-px-20'
                },
                {
                    targets: [3, 4, 5, 6],
                    className: 'text-center w-px-30'
                },
                {
                    targets: [7],
                    className: 'text-start text-lg-center w-px-20'
                },
    ...
    async function getProjects() {
        const url = `/projects/getProjectsByReo/${yearValue}/${divisionValue}`;
